USE bakery;
CREATE TABLE customer_sweepstake_staging(
...
INSERT INTO customer_sweepstake_staging(sweepstake_id, customer_id, phone, birth_date, address, total_money_spent, income, `Are_you_over_18`, favorite_color) 
